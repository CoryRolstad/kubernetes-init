...
master1=172.16.10.110
master2=172.16.10.120
master3=172.16.10.130
worker1=172.16.10.111
worker2=172.16.10.121
worker3=172.16.10.131
...
lbrange=172.16.10.200-172.16.10.254
...
k3sup install \
  ...
  --k3s-extra-args "--flannel-iface=$interface --node-ip=$master1 --node-taint node-role.kubernetes.io/master=true:NoSchedule" \
  --no-extras \
  --merge \
  --sudo \
