...
longhorn1=172.16.10.112
longhorn2=172.16.10.122
longhorn3=172.16.10.132
...
kubectl apply -f https://raw.githubusercontent.com/CoryRolstad/kubernetes-init/refs/heads/main/longhorn/longhorn.yaml
kubectl get pods \
